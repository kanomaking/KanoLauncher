...
- **`.mrpack` import** — validate against the pack's sha1/sha512 hashes. Note its URL whitelist is `cdn.modrinth.com`, `github.com`, `raw.githubusercontent.com`, `gitlab.com` only (no CurseForge).
